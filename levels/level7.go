...
func NewLevel7(game *screens.Game) *Level1 {
	return &Level1{
		Game: game,
	}
}

func (g *Level7) LoadMedia() error {
	var err error
	g.BaseGame.BackgroundImage, err = img.LoadTexture(g.Game.Renderer, "images/lvl7.png")
	if err != nil {
...
func (g *Level7) Run() screens.ScreenID {
	for true {
