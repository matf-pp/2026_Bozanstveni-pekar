...
func NewLevel6(game *screens.Game) *Level6 {
	return &Level6{
		Game: game,
	}
}

func (g *Level6) LoadMedia() error{
	var err error
	g.BaseGame.BackgroundImage, err = img.LoadTexture(g.Game.Renderer, "images/lvl6.png")
	if err != nil {
...
func (g *Level6) Run() screens.ScreenID {
	for true {
