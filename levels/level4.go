...
func NewLevel4(game *screens.Game) *Level4 {
	return &Level4{
		Game: game,
	}
}

func (g *Level4) LoadMedia() error {
	var err error
	g.BaseGame.BackgroundImage, err = img.LoadTexture(g.Game.Renderer, "images/lvl4.png")
	if err != nil {
...
func (g *Level4) Run() screens.ScreenID {
	for true {
