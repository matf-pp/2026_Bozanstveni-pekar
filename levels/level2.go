...
func NewLevel2(game *screens.Game) *Level2 {
	return &Level2{
		Game: game,
	}
}
...
func (g *Level2) LoadMedia() error{
	var err error
	g.BaseGame.BackgroundImage, err = img.LoadTexture(g.Game.Renderer, "images/lvl2.png")
	if err != nil {
...
func (g *Level2) Run() screens.ScreenID {
	for true {
